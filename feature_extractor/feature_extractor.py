...
DATASET_ROOT = '/home/taey16/storage/product'
...
if __name__ == '__main__':
  ...
  for item in input:
    try:
      ...
      feature= agent.extract_feature(image, 'pool5/7x7_s1', oversample)
      elapsed_process = time.time() - start_process
    ...
    if item_counter % 10 == 0: 
      print 'End of %d %.4f(%.4f)' % (item_counter, elapsed_process, elapsed_loading); sys.stdout.flush()
